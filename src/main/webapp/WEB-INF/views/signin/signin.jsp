...
<form id="signin" action="<c:url value="/signin/authenticate" />" method="post">
	...
	<fieldset>
		...
		<input id="login" name="j_username" type="text" size="25" <c:if test="${not empty signinErrorMessage}">value="${SPRING_SECURITY_LAST_USERNAME}"</c:if> /><br></br>
	...
	<form id="tw_signin" action="<c:url value="/signin/twitter"/>" method="POST">
		<button type="submit"><img src="<c:url value="/resources/images/signin_twitter.png"/>" /></button>
	</form>
